$(document).ready(function() {
    ...
    $(document).ready(function() {
        ...
        function showImage(category, index) {
            ...
            // 상세페이지의 경우 zoom 기능 비활성화
            if (category === 'detail') {
                $modalImage.css('cursor', 'default');
